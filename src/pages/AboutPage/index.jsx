        ...
        <section className={styles.main}>
            ...
            <div className={styles.div}>
                ...
                <ul>
                    ...
                    <li>05/2023 - atualmente: Desenvolvimento Web Full Stack (<a className={styles.link} href="https://kenzie.com.br/" target="_blank">Kenzie Academy Brasil</a>).</li>
                </ul>
            </div>
            <Footer />
        </section>
